...
- **مؤجَّل عمداً**: بوابة الإدارة، "نسيت كلمة المرور"، قائمة ثالثة لعروض المورد المعلَّقة أثناء نافذة المراجعة القصيرة (`REG_ADMIN_REVIEW_BIDS`) — مقبولة كقيد v1 لأن نظام الإشعارات الفعلي يُعلم المورد بأي تحوّل.
