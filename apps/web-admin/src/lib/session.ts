 ...
 */
export const SESSION_COOKIE = 'apex_admin_token';
export const REFRESH_COOKIE = 'apex_admin_refresh';
export const ACCESS_MAX_AGE_SECONDS = 60 * 60; // matches the backend's issueAdminToken expiresIn: '1h'
